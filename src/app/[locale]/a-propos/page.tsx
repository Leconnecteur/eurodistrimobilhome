...
export default async function AboutPage(props: PageProps<"/[locale]/a-propos">) {
  ...
  return (
    <div>
      <section className="bg-brand-anthracite py-20 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h1 className="font-heading text-3xl font-bold md:text-4xl">{dict.about.title}</h1>
          <p className="mx-auto mt-4 max-w-2xl text-white/70">{dict.about.intro}</p>
        </div>
      </section>
